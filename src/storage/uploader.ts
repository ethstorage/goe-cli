...
export interface StorageDriver {
  uploadPackAsBlobs(packBuf: Uint8Array | Buffer, opts?: { chunkSize?: number }): Promise<UploadBlobResult>;
...
export async function uploadPackAsBlobsGeneric(driver: StorageDriver, packBuf: Buffer, opts?: { chunkSize?: number }): Promise<UploadBlobResult> {
