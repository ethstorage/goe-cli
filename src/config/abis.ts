...
export const ETHSAbi = [
    ...
    "function getPushRecords(bytes calldata refName, uint256 start, uint256 limit) external view returns (tuple(bytes20 newOid, bytes20 oldOid, bytes20 packfileKey, uint256 size, uint256 timestamp, address pusher)[] memory)",
